<!-- filepath: c:\x2\htdocs\zing\tire_puncture.php -->
<?php
include 'header.php';
...
<head>
    ...
    <title>Tire Puncture Service</title>
    <style>
        body {
...
<body>
    ...
    <div class="hero-section">
        <div class="container">
            <h1 class="display-4">Tire Puncture Service</h1>
            <p class="lead">Quick and reliable tire puncture repair services near you.</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        if ($user_location) {
            // Query to fetch tire puncture service providers near the user
            $sql = "SELECT * FROM service_providers WHERE service_provided LIKE ? AND location = ?";
            $stmt = $conn->prepare($sql);
            $service = '%tire puncture%';
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<p class='no-providers'>No tire puncture service providers found near your location.</p>";
            }
