<!-- filepath: c:\x2\htdocs\zing\tow_service.php -->
<?php
include 'header.php';
...
<body>
    ...
    <div class="hero-section">
        <div class="container">
            <h1 class="display-4">Tow Service</h1>
            <p class="lead">Professional towing service to get your vehicle to safety.</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        if ($user_location) {
            // Query to fetch tow service providers near the user
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<p class='no-providers'>No tow service providers found near your location.</p>";
            }
