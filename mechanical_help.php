<!-- filepath: c:\x2\htdocs\zing\mechanical_help.php -->
<?php
include 'header.php';
...
<head>
    ...
    <title>Mechanical Help Service</title>
    <style>
        body {
...
<body>
    ...
    <div class="hero-section">
        <div class="container">
            <h1 class="display-4">Mechanical Help Service</h1>
            <p class="lead">Reliable mechanical help to get your vehicle back on the road.</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        if ($user_location) {
            // Query to fetch mechanical help service providers near the user
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<p class='no-providers'>No mechanical help service providers found near your location.</p>";
            }
